...
const OperationsSixthSection = () => {
  return (
    <>
      ...
      >
        <Typography paddingY={{xs:'25px', sm:'30px',md:'80px'}} paddingX={{xs:'25px', sm:'30px',md:'150px'}} fontSize={{xs:'20px',sm:'22px',md:'28px'}} fontWeight={500} textAlign='center' color='#fff' lineHeight='35px'>
