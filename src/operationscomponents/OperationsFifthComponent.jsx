...
const OperationsFifthSection = () => {
  return (
    <>
      <Box
        display='flex' flexDirection={{xs:'column',sm:'column',md:'row'}} justifyContent='center'
      >
        <Box sx={{ backgroundImage:`url(${operationsixthBg})`, backgroundSize:'cover', backgroundPosition:'center'}} paddingY={{xs:'80px', sm:'80px',md:'100px'}} display='flex' flexDirection='column' justifyContent='flex-start'>
            <Typography paddingX={{xs:'25px', sm:'30px',md:'50px'}} fontSize={{xs:'62px',sm:'62px',md:'72px',lg:'80px'}} fontWeight={700} textAlign='center' color='#A17337' lineHeight={{xs:'72px',sm:'72px',md:'94px'}}>
                QUALITY
            </Typography>
            <Box height={{xs:'9rem',sm:'9rem',md:'7rem'}}>

            </Box>
        </Box>
        <Box bgcolor='#A17337' paddingY={{xs:'25px', sm:'30px',md:'150px'}} display='flex' flexDirection='column' gap='1rem'>
            <Typography paddingX={{xs:'25px', sm:'30px',md:'50px'}} fontSize={{xs:'14px',sm:'14px',md:'14px',lg:'14px'}} fontWeight={400} color='#E5E5E5' lineHeight='20px'>
