...
const OperationsHero = () => {
  return (
    <>
      <Box className={classes.bg1} sx={{height:'76vh', backgroundImage:`url(${operationsmainBg})`,backgroundRepeat:'no-repeat',backgroundSize:'100% ',backgroundPosition:'center',zIndex:1}}
