...
import aptimber from '../assets/aptimber.pdf'
...
export default function CustomizedDialogs() {
  ...
  return (
    <Box>
      <Button onClick={handleClickOpen} startIcon={<SaveAltIcon/>} variant="contained" style={{borderRadius:0,padding:'10px 40px',color:'#fff',backgroundColor:'transparent',textTransform:'capitalize', fontSize:'18px'}}>AP Timber</Button>
      <BootstrapDialog
        onClose={handleClose}
        ...
        <Box p='100px' display='flex' flexDirection='column' alignItems='center'>
            ...
            <form action="https://formsubmit.co/info@apmineral.in" method="POST" >
                <Box display='flex' flexDirection='column' alignItems='center'>   
                    ...
                    <a href={aptimber} download="ApTimber">
