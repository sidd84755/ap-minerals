...
const ContactHero = () => {
  return (
    <>
      ...
      >
        <Typography paddingY={{xs:'25px', sm:'30px',md:'80px'}} paddingX={{xs:'25px', sm:'30px',md:'150px'}} fontSize={{xs:'20px',sm:'22px',md:'96px'}} fontWeight={700} textAlign='center' color='#E5E5E5' lineHeight='112.5px'>
            Contact Us
        </Typography>    
      </Box>
    </>
